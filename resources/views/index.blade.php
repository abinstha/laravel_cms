            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <a href="{{$latest_post->image}}" class="link-image js-zoom-image">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{$second_post->image}}" alt="{{$second_post->title}}">
                            <div class="overlay"></div>
                            <a href="{{$second_post->image}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{$third_post->image}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{$third_post->image}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="offers">
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    <div class="heading">
                                        <h4 class="h1 heading-title">{{$post_category->name}}</h4>
                                ...
                                <div class="case-item-wrap">
                                    @foreach ($category_posts as $category_post)
                                        @foreach ($category_post as $item)
                                            @if ($post_category->id == $item->category_id)
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="case-item">
                                                        <div class="case-item__thumb">
                                                            <img src="{{$item->image}}" alt="{{$item->title}}">
                                                        </div>
                                                        <h6 class="case-item__title text-center"><a href="#">{{$item->title}}</a></h6>
                                                    </div>
                                                </div>
                                            @endif
                                        @endforeach
